...
<html lang="ru">
  ...
  <body class="goto-here">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Milk Project</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="index.html" class="nav-link">Главная страница</a></li>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/002.jpg);">
					</div>
					<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Добро пожаловать на веб-приложение компании Milk Project</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Путь к вашим витринам начинается с современных приемных пунктов, оснащенных новейшим оборудованием, где молоко уже в первые часы проходит этапы очистки и охлаждения. Производство наших молочных продуктов находится в экологически чистом районе, что гарантирует высокое качество и свежесть продукции.
                Наш продукт вырабатывается по новейшим технологиям с применением инновационных научных разработок, что позволяет уничтожать болезнетворные бактерии, но при этом оставлять высокое содержание витаминов и микроэлементов.</p>
							<p>В продукции полностью отсутствуют консерванты. Благодаря этому, мы бережно сохраняем лучшее, что подарила нам природа - пользу и вкус свежего молока, богатого минералами и микроэлементами, необходимыми для крепкого здоровья и естественной красоты.
                Мы предлагаем новые бренды в сегменте молочной продукции. Предприятие нацелено на высокотехнологическую переработку цельного молока и упаковку молочной продукции.
                Завод оснащен современным инновационным оборудованием производства компаний Израиля, Швеции и России.
                </p>
							<p><a href="index.html" class="btn btn-primary">Купить продукцию</a></p>
						</div>
					</div>
				</div>
			</div>
